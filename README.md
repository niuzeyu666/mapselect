...
一个用于朋友自定义房间开黑的 VALORANT 随机地图选择器，也包含 VCT 风格 Ban/Pick 模拟器。网站是纯静态实现，可以直接部署到 GitHub Pages。

## 功能

- 自定义房间随机地图：从全部标准 5v5 爆破地图中随机选择。
- VCT Ban/Pick 模拟：支持 Bo1、Bo3、Bo5，按官方 VCT 规则中的 Team A / Team B 顺序随机执行 ban、pick 和选边。
